...
namespace API.Domain.Validators.Barbers
{
    ...
    {
        private readonly IUnitOfWork<Barbero> _repositorios;

        public BarberoValidator(IUnitOfWork<Barbero> repositorios)
        {
            ...
            RuleFor(m => m.EstaAfiliadoABarberia).NotEmpty().WithMessage("No puede ser un texto vacio.")
                                .NotNull().WithMessage("Es un campo obligatorio.");
            ...
            //RuleFor(m => m.BarberiaId).NotEmpty().WithMessage("No puede ser un texto vacio.")
            //                    .NotNull().WithMessage("Es un campo obligatorio.");
