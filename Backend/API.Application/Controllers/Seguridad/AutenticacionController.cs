...
namespace API.Application.Controllers.Seguridad
{
    ...
    public class AutenticacionController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("[action]")]
        public async Task<ActionResult> ObtenerInformacionUsuario(Guid id)
        {
            var usuario = await _usuarioService.ObtenerDatosUsuarioPorId(id);
            return Ok(new ResponseDto { Status = StatusCodes.Status200OK, Result = usuario });
        }
