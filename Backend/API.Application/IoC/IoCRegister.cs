...
using API.Domain.Services.Barbers;
...
namespace API.Application.IoC
{
    public static class IoCRegister
    {
        ...
        public static IApplicationBuilder AddRegistration(WebApplication app, IWebHostEnvironment env)
        {
            ...
            app.UseAuthentication(); // <-- si tienes autenticación, también debe ir antes de Authorization
        ...
        public static IServiceCollection RegistrarServiciosDominio(this IServiceCollection services)
        {
            ...
            services.AddScoped<ISolicitudDeSuscripcionService, SolicitudDeSuscripcionService>();
            services.AddScoped<ISolicitudDeAfiliacionService, SolicitudDeAfiliacionService>();
            services.AddScoped<IAdminService, AdminService>();
            services.AddScoped<IResenhaService, ResenhaService>();
