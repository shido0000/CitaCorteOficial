<template>
    <q-page padding>
        <div class="text-h6">Registro de Barberías / Barberos Pendientes</div>
...
const aprobar = async (id) => {
    await api.put(`/admin/registro-barberias/${id}/aprobar`)
...
const recargar = async () => {
    const { data } = await api.get('Admin/ObtenerBarberiasYBarberos')
